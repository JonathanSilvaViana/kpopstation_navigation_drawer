...
public class ParceirosFragment extends Fragment {
    ...
    public static ParceirosFragment newInstance(String param1, String param2) {
        ParceirosFragment fragment = new ParceirosFragment();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        url = "https://kpopstation.com.br/novo/paepa";

        webView = (WebView) view.findViewById(R.id.webparceiros);
        webView.loadUrl(url);
        ...
        } else if (networkInfo == null)
        {
            ...
            alertDialogBuilder
                    ...
                    .setNegativeButton("Não", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            dialog.cancel();
                            Intent mandaparahomedenovo = new Intent(getContext(), MainActivity.class);
            ...
            Toast.makeText(getContext(), "Sem rede", Toast.LENGTH_SHORT).show();
            System.exit(1);
